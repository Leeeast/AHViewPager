...
/**
 * Created by lidongliang on 2017/7/26.
...
public class AHViewPager extends ViewPager {
    ...
    protected AHInterface<SimpleDraweeView> mu5Interface;//Mu5ViewPager涉及到的一切事件回调
     ...
     * @param mu5Interface
     */
    public void setMu5Interface(AHInterface<SimpleDraweeView> mu5Interface) {
    ...
    protected OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            //为ViewPager设置高度
            ViewGroup.LayoutParams params = AHViewPager.this.getLayoutParams();
            params.height = height;
            AHViewPager.this.setLayoutParams(params);
    ...
    public AHViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * @param mu5Interface
     */
    public void setData(List<String> urls, AHInterface mu5Interface) {
        if (urls == null || urls.size() == 0)
            throw new RuntimeException("error:don't give a empty source to me!");
        this.mu5Interface = mu5Interface;
        sourceHeights = new int[urls.size()];
        mu5PagerAdapter = new AHPagerAdapter(getContext(), urls, mu5Interface);
     ...
     * @param mu5Interface
     */
    public void setData(String[] urls, AHInterface mu5Interface) {
